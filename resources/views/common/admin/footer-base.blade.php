...
<script>
    ...
    <script src="{{ asset('assets/js/pages/crud/ktdatatable/base/html-table.js?v=7.0.5') }} "></script>
    <script src="{{ asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js?v=7.0.5') }} "></script>
    <script src="{{ asset('assets/js/pages/crud/forms/editors/ckeditor-classic.js?v=7.0.5') }} "></script>
    ...
    <script src="{{ asset('assets/js/pages/crud/file-upload/dropzonejs.js?v=7.0.5') }} "></script>
    <!--end::Page Scripts-->
    <script>
    // Class definition
